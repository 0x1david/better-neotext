...
pub fn get_info_bar_content(term_width: usize, mode: &Modal, pos: &mut LineCol) -> String {
...
/// Logs the error as error LEVEL with tracing and reports to the notification bar
